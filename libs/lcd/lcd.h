...
#define LCD_DATA0_PIN    PINA0        /**< pin for 4bit data bit 0  */
#define LCD_DATA1_PIN    PINA1        /**< pin for 4bit data bit 1  */
#define LCD_DATA2_PIN    PINA2        /**< pin for 4bit data bit 2  */
#define LCD_DATA3_PIN    PINA3        /**< pin for 4bit data bit 3  */
...
extern void lcd_putsnl(const char *s);
